...
import { Star, Info, Shield, Check, ThumbsUp, Clock, Users } from 'lucide-react';
import {
  Table,
  TableBody,
  TableCell,
  ...
  return (
    <Layout>
      ...
      <HeroHeader
        ...
        title={
          <>
            Top <span className="text-gokkerz-green">Online Casino's</span> Nederland
          </>
        }
        description="Vergelijk alle legale online casino’s van Nederland. Bekijk actuele reviews, betrouwbare ervaringen en vind het beste casino voor jouw speelstijl. Altijd veilig, eerlijk en up-to-date."
        bullets={[
          {
            icon: <Star className="h-4 w-4 text-gokkerz-green" />,
            text: 'Actuele Reviews & Ratings',
          },
          { icon: <Shield className="h-4 w-4 text-gokkerz-green" />, text: '100% Legaal & Veilig' },
          {
            icon: <Users className="h-4 w-4 text-gokkerz-green" />,
            text: 'Echte Spelerservaringen',
          },
        ]}
      />

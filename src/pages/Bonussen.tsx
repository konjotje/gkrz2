  ...
  return (
    <Layout>
      ...
      <HeroHeader
        ...
        description="Ontdek en vergelijk de hoogste, nieuwste en veiligste casino bonussen van Nederland. Altijd actueel, 100% legaal en door experts gecontroleerd."
        bullets={[
